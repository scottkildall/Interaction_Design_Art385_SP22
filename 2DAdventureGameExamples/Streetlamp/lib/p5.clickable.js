...
function Clickable() {
	...
	this.width = 120;		//Width of the clickable
	...
	this.textY = 0;			// Offset for text Y position (in case your font has a weird relationship with its baseline)
	...
	this.draw = function () {
		...
		text(this.text, this.x + this.width / 2, this.y + this.height / 2 + this.textY);
